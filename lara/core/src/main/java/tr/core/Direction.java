...
public enum Direction {
  ...
  static {
    ...
    addControl(UP, Control.UP);
    addControl(DOWN, Control.DOWN);
    addControl(LEFT, Control.LEFT);
    addControl(RIGHT, Control.RIGHT);
  }
  ...
  private static void addControl(Direction d, Control c) {
    d.control = c;
    c.direction = d;
  }
}
